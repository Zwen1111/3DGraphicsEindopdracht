...
//*/
//model_component::model_component(const std::string &fileName)
//{
...
//
//
//void model_component::loadMaterialFile(const std::string &fileName, const std::string &dirName)
//{
//	std::cout << "Loading " << fileName << std::endl;
//	std::ifstream pFile(fileName.c_str());
//	if (!pFile.is_open())
...
//}
//
//model_component::MaterialInfo::MaterialInfo()
//{
//	texture = NULL;
//}